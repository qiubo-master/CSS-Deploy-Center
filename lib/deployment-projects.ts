...
export const builtInProjects: DeploymentProject[] = [
  ...
  { id: "ontology", name: "汽车后市场 Ontology", repository: process.env.ONTOLOGY_GITHUB_REPOSITORY ?? "qiubo-master/Ontology", workflow: "deploy-project.yml", branch: "master", description: "智能客服意图、对象、规则、能力与决策链路运行平台", manualUrl: "https://github.com/qiubo-master/Ontology/blob/master/README.md", healthUrl: process.env.ONTOLOGY_HEALTH_URL ?? "http://100.103.132.88:8090/api/health", endpoint: process.env.ONTOLOGY_PUBLIC_URL ?? "http://100.103.132.88:8090", defaultPort: 8090, centralDeployment: true, resourceManaged: true, targetIds: ["aliyun-main"] },
