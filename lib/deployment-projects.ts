...
export const builtInProjects: DeploymentProject[] = [
  ...
  { id: "css", name: "智能客服", repository: process.env.CSS_GITHUB_REPOSITORY ?? "qiubo-master/CSS", workflow: process.env.CSS_GITHUB_WORKFLOW_FILE ?? "deploy.yml", branch: "master", description: "汽车后市场智能客服与轮胎业务服务", projectUrl: process.env.CSS_PUBLIC_URL ?? "https://github.com/qiubo-master/CSS", manualUrl: "https://github.com/qiubo-master/CSS/blob/master/README.md", healthUrl: process.env.CSS_HEALTH_URL, endpoint: process.env.CSS_PUBLIC_URL ?? "尚未配置线上访问地址", resourceManaged: false, targetIds: ["aliyun-main"] },
  { id: "ai-ops", name: "AI运营", repository: "qiubo-master/AI_OPS", workflow: "deploy-project.yml", branch: "master", description: "门店运营、巡检与业务编排智能平台", projectUrl: "https://github.com/qiubo-master/AI_OPS", manualUrl: "https://github.com/qiubo-master/AI_OPS/blob/master/README.md", endpoint: "尚未部署线上页面", centralDeployment: true, resourceManaged: true, targetIds: ["aliyun-main"] },
  { id: "ai-wms", name: "AI供应链", repository: "qiubo-master/AI_WMS", workflow: "deploy-project.yml", branch: "master", description: "供应链智能备货与仓储决策平台", projectUrl: "https://github.com/qiubo-master/AI_WMS", manualUrl: "https://github.com/qiubo-master/AI_WMS/blob/master/README.md", endpoint: "尚未部署线上页面", centralDeployment: true, resourceManaged: true, targetIds: ["aliyun-main"] },
  { id: "media", name: "序章自媒体中台", repository: process.env.MEDIA_GITHUB_REPOSITORY ?? "qiubo-master/Media", workflow: process.env.MEDIA_GITHUB_WORKFLOW_FILE ?? "deploy.yml", branch: "master", description: "内容生产、账号矩阵与 AI 决策中台", projectUrl: process.env.MEDIA_PUBLIC_URL ?? "http://100.103.132.88:8080", manualUrl: "https://github.com/qiubo-master/Media/blob/master/README.md", healthUrl: process.env.MEDIA_HEALTH_URL, endpoint: process.env.MEDIA_PUBLIC_URL ?? "http://100.103.132.88:8080", resourceManaged: true, targetIds: ["aliyun-main"] },
  { id: "word-game", name: "WordGame 单词闯关", repository: process.env.WORD_GAME_GITHUB_REPOSITORY ?? "qiubo-master/WordGame", workflow: process.env.WORD_GAME_GITHUB_WORKFLOW_FILE ?? "cloudbase.yml", branch: "master", description: "支持账号、闯关和进度存档的单词学习游戏", manualUrl: "https://github.com/qiubo-master/WordGame/blob/master/deploy-cloudbase.md", healthUrl: process.env.WORD_GAME_HEALTH_URL ?? "https://wordgame-1-d7gx6qvym115a8f41-1348325609.ap-shanghai.app.tcloudbase.com/wqapi/api/health", endpoint: process.env.WORD_GAME_PUBLIC_URL ?? "https://wordgame-1-d7gx6qvym115a8f41.tcloudbase.com", resourceManaged: false, targetIds: [] },
  ...
  { id: "otel", name: "Otel 可观测平台", repository: process.env.OTEL_GITHUB_REPOSITORY ?? "qiubo-master/Otel", workflow: process.env.OTEL_GITHUB_WORKFLOW_FILE ?? "deploy.yml", branch: "main", description: "统一采集指标、链路与日志，提供 Grafana、Prometheus、Tempo 和 Elasticsearch 可观测能力", projectUrl: process.env.OTEL_PUBLIC_URL ?? "https://github.com/qiubo-master/Otel", manualUrl: "https://github.com/qiubo-master/Otel/blob/main/docs/OPERATIONS.md", healthUrl: process.env.OTEL_HEALTH_URL ?? "http://100.103.132.88:13133", endpoint: process.env.OTEL_PUBLIC_URL ?? "尚未配置线上访问地址", defaultPort: 3000, resourceManaged: true, targetIds: ["aliyun-main"] },
  ...
  { id: "eval", name: "Eval 评测系统", repository: "qiubo-master/eval", workflow: "deploy.yml", branch: "master", description: "大模型、Prompt 与应用效果评测系统", projectUrl: "https://github.com/qiubo-master/eval", manualUrl: "https://github.com/qiubo-master/eval/blob/master/README.md", endpoint: "尚未部署线上页面", resourceManaged: false, targetIds: [] },
];
