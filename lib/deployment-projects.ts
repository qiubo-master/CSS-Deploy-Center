...
export const builtInProjects: DeploymentProject[] = [
  ...
  { id: "gfm", name: "GFM 通用大模型基座", repository: process.env.GFM_GITHUB_REPOSITORY ?? "qiubo-master/GFM", workflow: process.env.GFM_GITHUB_WORKFLOW_FILE ?? "deploy.yml", branch: "main", description: "统一提供 Qwen 文本、Embedding、YOLO、OCR 与 Qwen-VL 多模态 API", healthUrl: process.env.GFM_HEALTH_URL ?? "https://uu800904-ada3-4b719cf9.westb.seetacloud.com:8443/foundation/v1/health", endpoint: process.env.GFM_PUBLIC_URL ?? "https://uu800904-ada3-4b719cf9.westb.seetacloud.com:8443/", resourceManaged: false, targetIds: ["autodl2"] },
];
