    ...
    <section className="workspace">
      ...
      <div className="content">
        <section className="panel serverPanel" id="servers">
          ...
          <div className="releaseActions" style={{ marginBottom: 12 }}><label>管理员令牌<input type="password" value={adminToken} onChange={(event) => setAdminToken(event.target.value)} placeholder="接入服务器需要令牌"/></label></div>
