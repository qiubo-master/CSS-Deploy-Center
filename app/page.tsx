...
type ProjectId = "css" | "media" | "ai-wms" | "ai-ops";
...
const seed: Dashboard = {
  ...
  projects: [
    ...
    { id: "ai-wms", name: "AI供应链智能备货", repository: "qiubo-master/AI_WMS", branch: "main", description: "轮胎需求预测、库存监控与AI解释演示系统", endpoint: "http://47.120.61.139:3000", resourceManaged: false, targetIds: ["aliyun2"] },
